...
import { useToast, Heading, Select, Button, type ButtonProps } from '@chakra-ui/react'
import { generateCommitment } from './util'
import { Cartesify } from '@calindra/cartesify'
import { DAPP_ADDRESS, MOVE_KEY, NONCE_KEY } from './constants'
...
function Challenges({ challenges, address, signer, showAccept = false }) {
  ...
  const buttonAcceptProps: ButtonProps = {}
  if (acceptLoading) buttonAcceptProps.isLoading = true

  const buttonRevealProps: ButtonProps = {}
            ...
            <div className="challenge" key={challenge.challenge_id}>
              ...
              {!challenge.winner && challengeDone(challenge) && (
                <p>
                  ...
                  :
                  {' '}
                  <strong style={{ color: 'yellow' }}>Draw</strong>
                </p>
              )}
